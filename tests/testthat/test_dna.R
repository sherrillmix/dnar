...
test_that("Test addSnpsToGenome",{
  expect_equal(addSnpsToGenome('ABCD'),'ABCD')
  expect_equal(addSnpsToGenome(''),'')
  expect_equal(addSnpsToGenome('CCACC',c('A3T')),'CCTCC')
  expect_equal(addSnpsToGenome('ABCDEFGHIJKL',c('L12Z')),'ABCDEFGHIJKZ')
  expect_equal(addSnpsToGenome('ABCDEFGHIJKL',c('B2Z','D4Y')),'AZCYEFGHIJKL')
  expect_error(addSnpsToGenome('ABCDEFGHIJKL',c('C2Z','D4Y')),'[Mm]ismatch')
  expect_error(addSnpsToGenome('ABCDEFGHIJKL',c('B2Z','E4Y')),'[Mm]ismatch')
  expect_error(addSnpsToGenome('ABCDEFGHIJKL',c('B-2Z','D4Y')),'less')
  expect_error(addSnpsToGenome('ABCDEFGHIJKL',c('B20Z','D4Y')),'longer')
  expect_error(addSnpsToGenome('ABCDEFGHIJKL',c('B0Z','D4Y')),'less')
  expect_equal(addSnpsToGenome('ABCDEFGHIJKL',deletions=c('1-4','6')),'----E-GHIJKL')
  expect_equal(addSnpsToGenome('CCACC',deletions=c('2-4')),'C---C')
  expect_error(addSnpsToGenome('ABCDEFGHIJKL',deletions=c('-2-4')),'[Mm]alformed')
  expect_error(addSnpsToGenome('ABCDEFGHIJKL',deletions=c('2--4')),'[Mm]alformed')
  expect_error(addSnpsToGenome('ABCDEFGHIJKL',deletions=c('ABC')),'[Mm]alformed')
  expect_error(addSnpsToGenome('ABCDEFGHIJKL',deletions=c('0-4')),'less')
  expect_error(addSnpsToGenome('ABCDEFGHIJKL',deletions=c('1-13')),'longer')
  expect_equal(addSnpsToGenome('ABCDEFGHIJKL',insertions=c('4XYZ','6VW')),'ABCDXYZEFVWGHIJKL')
  expect_equal(addSnpsToGenome('ABCDEFGHIJKL',insertions=c('0XYZ','12VW')),'XYZABCDEFGHIJKLVW')
  expect_equal(addSnpsToGenome('CCACC',insertions=c('3TT')),'CCATTCC')
  expect_equal(addSnpsToGenome('ABCDEFGHIJKL',insertions=c('3')),'ABCDEFGHIJKL')
  expect_error(addSnpsToGenome('ABCDEFGHIJKL',insertions=c('ABC')),'[Mm]alformed')
  expect_error(addSnpsToGenome('ABCDEFGHIJKL',insertions=c('-1ABC')),'[Mm]alformed')
  expect_error(addSnpsToGenome('ABCDEFGHIJKL',insertions=c('13ABC')),'longer')
})
